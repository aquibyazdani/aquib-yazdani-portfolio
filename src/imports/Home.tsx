...
function Column() {
  return (
    <div className="content-stretch flex font-['Inter:Medium',sans-serif] font-medium gap-[32px] items-start not-italic overflow-clip relative shrink-0 text-[#c7c7c7] text-[16px] text-nowrap tracking-[-0.48px] whitespace-pre" data-name="Column">
...
function HeaderAndSubHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="header and sub header">
      <div className="font-['Bebas_Neue:Regular',sans-serif] leading-[0.9] not-italic relative shrink-0 text-[101px] text-white w-full">
...
function Button() {
  return (
    <div className="bg-[#d3e97a] box-border content-stretch flex gap-[12px] h-[54px] items-center justify-center pl-[24px] pr-[6px] py-[20px] relative rounded-[100px] shrink-0" data-name="button">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-none relative shrink-0 text-[16px] text-neutral-950 text-nowrap uppercase whitespace-pre">Contact Me</p>
      <Circle />
    </div>
  );
}
...
function HeroContent() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[40px] items-start left-[108px] pb-[22px] pt-0 px-0 top-[286px] w-[544px]" data-name="hero content">
      <HeaderAndSubHeader />
      <Action />
    </div>
  );
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[600px]">
      <p className="font-['Bebas_Neue:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[76px] text-nowrap text-white whitespace-pre">Featured Projects</p>
...
function Tag() {
  return (
    <div className="absolute bg-neutral-950 box-border content-stretch flex gap-[10px] items-center justify-center left-[16px] px-[16px] py-[8px] rounded-[100px] top-[16px]" data-name="tag">
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Conceptual Work</p>
    </div>
  );
}
...
function Card() {
  return (
    <div className="absolute bg-[#1a1a1a] left-1/2 overflow-clip rounded-[12px] size-[600px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="card">
      <div className="absolute h-[347px] left-1/2 pointer-events-none rounded-[12px] top-[calc(50%-0.5px)] translate-x-[-50%] translate-y-[-50%] w-[486px]" data-name="work">
...
function TitleAndDescription() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="title and description">
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[32px] text-white w-full">Promotional landing page for our favorite show</p>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#c7c7c7] text-[18px] w-full">Teamed up with a designer to breathe life into a promotional webpage for our beloved show, Adventure Time. Delivered a fully responsive design with dynamic content capabilities, seamlessly integrating a newsletter feature to keep fans updated with the latest adventures.</p>
    </div>
  );
}
...
function Year() {
  return (
    <div className="box-border content-stretch flex items-center justify-between px-0 py-[16px] relative shrink-0 w-full" data-name="year">
      <div aria-hidden="true" className="absolute border-[#484848] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Year</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[#c7c7c7] text-[16px] text-nowrap whitespace-pre">2023</p>
    </div>
  );
}
...
function Role() {
  return (
    <div className="box-border content-stretch flex items-center justify-between px-0 py-[16px] relative shrink-0 w-full" data-name="role">
      <div aria-hidden="true" className="absolute border-[#484848] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Role</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[#c7c7c7] text-[16px] text-nowrap whitespace-pre">Front-end Developer</p>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col items-end justify-center relative shrink-0 w-full" data-name="List">
      <div aria-hidden="true" className="absolute border-[#484848] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Year />
      <Role />
    </div>
  );
...
function ProjectInfo() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="project info">
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[1.5] relative shrink-0 text-[16px] text-nowrap text-white uppercase whitespace-pre">Project Info</p>
      <List />
    </div>
  );
}
...
function TitleAndArrow() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="title and arrow">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#d3e97a] text-[16px] text-nowrap uppercase whitespace-pre">Live Demo</p>
      <Arrow />
    </div>
  );
}
...
function TitleAndArrow1() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="title and arrow">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#d3e97a] text-[16px] text-nowrap uppercase whitespace-pre">See on Github</p>
      <BxlGithubSvg1 />
    </div>
  );
}
...
function ProjectContent() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[48px] grow items-start min-h-px min-w-px relative shrink-0" data-name="project content">
      <Information />
      <Frame21 />
    </div>
  );
...
function ProjectImage() {
  return (
    <div className="bg-[#1a1a1a] overflow-clip relative rounded-[12px] shrink-0 size-[600px]" data-name="project image">
      <div className="absolute h-[347px] left-1/2 rounded-[12px] top-[calc(50%+0.5px)] translate-x-[-50%] translate-y-[-50%] w-[488px]" data-name="image 10">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[12px] size-full" src={imgImage10} />
      </div>
    </div>
  );
}
...
function Client() {
  return (
    <div className="box-border content-stretch flex items-center justify-between px-0 py-[16px] relative shrink-0 w-full" data-name="client">
      <div aria-hidden="true" className="absolute border-[#484848] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Client</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[#c7c7c7] text-[16px] text-nowrap whitespace-pre">World News</p>
    </div>
  );
}
...
function Year1() {
  return (
    <div className="box-border content-stretch flex items-center justify-between px-0 py-[16px] relative shrink-0 w-full" data-name="year">
      <div aria-hidden="true" className="absolute border-[#484848] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Year</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[#c7c7c7] text-[16px] text-nowrap whitespace-pre">2022</p>
    </div>
  );
}
...
function TitleAndArrow2() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0" data-name="title and arrow">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#d3e97a] text-[16px] text-nowrap uppercase whitespace-pre">View project</p>
      <Arrow1 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="absolute bg-neutral-950 box-border content-stretch flex gap-[10px] items-center justify-center left-[16px] px-[16px] py-[8px] rounded-[100px] top-[16px]">
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Challenge</p>
    </div>
  );
}
...
function ProjectImage1() {
  return (
    <div className="bg-[#1a1a1a] overflow-clip relative rounded-[12px] shrink-0 size-[600px]" data-name="project image">
      <div className="absolute h-[306px] left-1/2 rounded-[12px] top-1/2 translate-x-[-50%] translate-y-[-50%] w-[488px]" data-name="image 9">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[12px] size-full" src={imgImage9} />
      </div>
      <Frame12 />
    </div>
  );
...
function TitleAndDescription2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="title and description">
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[1.4] relative shrink-0 text-[32px] text-white w-full">E-commerce product page</p>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#c7c7c7] text-[18px] w-full">Successfully crafted an engaging product page featuring a dynamic lightbox gallery and seamless cart functionality, showcasing proficiency in JavaScript development.</p>
    </div>
  );
}
    ...
    <div className="bg-[#1a1a1a] relative rounded-[4px] shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex gap-[10px] items-start px-[16px] py-[12px] relative w-full">
          <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] text-nowrap text-white whitespace-pre">John Doe</p>
        </div>
      </div>
    </div>
  );
...
function ViewProject5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-[628px] top-[3740px]" data-name="view project">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#d3e97a] text-[16px] text-nowrap uppercase whitespace-pre">More about me</p>
      <div className="h-0 relative shrink-0 w-full" data-name="underline">
        <div className="absolute bottom-0 left-0 right-0 top-[-2px]">
...
export default function Home() {
  return (
    <div className="bg-neutral-950 relative size-full" data-name="Home">
      ...
      <Frame19 />
      <Frame8 />
      <p className="absolute font-['Bebas_Neue:Regular',sans-serif] leading-[0.9] left-[calc(50%-612px)] not-italic text-[101px] text-nowrap text-white top-[3446px] whitespace-pre">About me</p>
      <Frame22 />
      <ViewProject5 />
    </div>
  );
