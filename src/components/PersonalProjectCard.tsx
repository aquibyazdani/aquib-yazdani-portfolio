    ...
    <div className="bg-[#1a1a1a] rounded-[12px] overflow-hidden group hover:bg-[#222222] transition-colors">
      <div className="aspect-video relative overflow-hidden bg-[#0a0a0a]">
        {img ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center text-[64px] text-[#333]">{displayTitle.charAt(0)}</div>
        )}
      </div>
      <div className="p-6 space-y-4">
        <h3 className="font-['Bebas_Neue',sans-serif] text-[24px] text-white leading-[1.4]">{displayTitle}</h3>
        {project.url && (
